...
- Your adherence as the AI assistant

## Planning Guidelines

- **No Timelines**: Do not include time estimates, week numbers, or deadlines in plans or documentation. Focus on quality and correctness, not speed.
- **Focus on Quality**: Emphasize building each component correctly rather than quickly.
- **Sequential Phases**: Break work into logical phases with clear deliverables, but without time constraints.
